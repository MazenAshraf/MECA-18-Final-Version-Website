          ...
          <!--  <div>
            ...
            <div class="row" style="width:100% !important;">
                ...
                <div class="col-md-6" id="layer1">
                                    <h1 style="text-align: center;font-size: 7vw; color: orange;
">Sorry </h1>
<p style="text-align: center; color: orange; font-family: 'Bree Serif', serif; font-size: 32px;margin-top: 5%; margin-bottom: 10%; letter-spacing: 2px;">You haven't pass the test.<br>
We will be waiting for you in our upcoming events.you will always be our Main Asset.</p>
