...
<!--registeration form-->
    ...
    <div id="background">
        ...
        <h1 style="text-align: center;font-size: 7vw; color: orange; font-family: 'Berkshire Swash', cursive;"> Stay tuned ..!</h1>
<p style="text-align: center; color: orange; font-family: 'Bree Serif', serif; font-size: 32px;margin-top: 5%; margin-bottom: 10%; letter-spacing: 2px;"> The link will be available tomorrow at 7 PM  </p>
...
<!--copywrites-->
    <div class="row">
      <div class="copywrites" class="col-md-4" style="display: flex; align-items: center; font-family: Georgia;">
        © MECA'19 Developed by MECA IT Committee
      </div>
    </div>
  </div>
</div>
