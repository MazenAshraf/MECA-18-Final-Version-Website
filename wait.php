    ...
    <div id="background">
        <div id="layer">
          <!--  <div>
            ...
            <h1 style="text-align: center;font-size: 7vw; color: orange; font-family: 'Berkshire Swash', cursive;"> You have finished your application </h1>
<p style="text-align: center; color: orange; font-family: 'Bree Serif', serif; font-size: 32px;margin-top: 5%; margin-bottom: 10%; letter-spacing: 2px;"> Good luck in your interview ;) </p>
