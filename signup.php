...
<!--registeration form-->
  ...
  <div class="form-group">
    <label for="inputAddress2" style="color:orange; font-size: 18px;">Full Name:</label>
    <input type="name" class="form-control" id="inputName" placeholder="Full Name" required name="Name">
  </div>

  <div class="form-group">
    <label for="inputNumber" style="color:orange; font-size: 18px;">Mobile:</label>
    <input type="inputNumber" class="form-control" id="inputNumber" pattern="\d*" placeholder="Phone Number" maxlength="11 " title="01XXXXXXXXX" required name="Mobile">
  </div>
  <div class="form-group">
      ...
      <select id="inputState" class="custom-select" style="width: 100%; height: 15%;" required name="Major">
        <option value="">Select your Major</option>
            <option value='Mechanical'>Mechanical</option>
             ...
             <option value='Automotice'>Automotive</option>
   ...
   <div class="form-group">
    <label  style="color:orange; font-size: 18px;">Your Faculty ID:</label>
    <input  class="form-control" id="inputNumber" maxlength="10"  placeholder="ID"  title="Faculty ID"  name="col-ID">
  </div>

    <br>
    <button type="Submit" class="btn btn-warning btn-lg" style="width: 40%; margin-left: 30%;" name="reg_students">Submit</button>
    <br>
...
<div class="row">
<div class="social-media-links" class="col-md-4" style="display: flex; align-items: center; ">
      <a class="link" href=''><i class="fa fa-facebook-official fa-2x fa-fw"></i></a>
      <a class="link" href=''><i class="fa fa-twitter-square fa-2x fa-fw"></i></a>
      <a class="link" href='https://www.youtube.com/user/MECAEgypt'><i class="fa fa-youtube-play fa-2x fa-fw"></i></a>
      <a class="link" href=''><i class="fa fa-instagram fa-2x fa-fw"></i></a>
  </div>
</div>
